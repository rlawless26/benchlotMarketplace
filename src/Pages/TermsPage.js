  ...
  return (
    <div className="bg-bone min-h-screen py-12">
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-bone-light rounded-lg shadow-md p-8">
          <h1 className="text-3xl font-display font-medium text-dark-teal mb-6">Terms of Service</h1>
          <p className="text-secondary mb-8">Last Updated: April 20, 2025</p>
          ...
          <div className="mt-8 border-t border-stone-200 pt-6 flex justify-between">
            <Link to="/help" className="text-spruce hover:text-spruce-light">
              Back to Help Center
            </Link>
            <Link to="/privacy" className="text-spruce hover:text-spruce-light">
              Privacy Policy
            </Link>
          </div>
        </div>
