    ...
    return (
      <div className="page-container min-h-[70vh] flex justify-center items-center">
        <div className="animate-pulse flex flex-col items-center">
          ...
          <p className="mt-4 text-benchlot-primary font-medium">Loading your listings...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="page-container py-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <h1 className="text-2xl md:text-3xl font-bold text-benchlot-primary">My Tool Listings</h1>
        <Link
          to="/tools/new"
      ...
      {listings.length === 0 ? (
        ...
        <div className="space-y-6">
          {listings.map((tool) => (
            <div key={tool.id} className="card p-4 sm:p-6 flex flex-col sm:flex-row gap-4 transition-all hover:shadow-card-hover">
              {/* Tool Image */}
