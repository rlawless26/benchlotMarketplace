        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-16">
            <div>
              ...
              <p className="text-sm mb-4 font-display italic" style={{ fontWeight: 500 }}>The woodworker's marketplace.</p>
              <p className="text-sm mb-6" style={{ color: '#6a8a84' }}>The marketplace for premium used hand tools.</p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-2 text-sm">
                  ...
                  <a href="mailto:hello@rekerf.com" className="hover:text-bone transition-colors font-body" style={{ color: '#6a8a84' }}>hello@rekerf.com</a>
                </li>
                <li className="mt-4">
                  <a href="https://www.instagram.com/rekerf/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-bone transition-colors font-body" style={{ color: '#6a8a84' }}>
                    <Instagram className="h-5 w-5" /><span className="text-sm">@rekerf</span>
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div className="mt-12 pt-6 border-t border-dark flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex gap-6">
              <Link to="/privacy" className="text-xs hover:text-bone transition-colors font-body" style={{ color: '#6a8a84' }}>Privacy Policy</Link>
              <Link to="/terms" className="text-xs hover:text-bone transition-colors font-body" style={{ color: '#6a8a84' }}>Terms of Service</Link>
            </div>
            <div className="text-xs" style={{ color: '#6a8a84' }}>Made with care in Boston</div>
          </div>
        </div>
      </footer>
    );
