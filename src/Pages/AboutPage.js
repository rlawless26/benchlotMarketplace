  ...
  return (
    <div className="bg-bone min-h-screen">
      <main className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="mb-20">
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
            <div className="md:w-1/3">
              <div className="bg-bone-light rounded-lg overflow-hidden shadow-md">
                <div className="aspect-square bg-stone-100 flex items-center justify-center">
                  <span className="text-stone-400 text-sm">Founder Image</span>
                </div>
                <div className="p-4">
                  <h3 className="font-display text-xl font-medium text-spruce">Rob</h3>
            ...
            <div className="md:w-2/3">
              <h2 className="text-3xl font-display font-medium text-spruce mb-6">
                Our Story
              </h2>
        ...
        {/* Our Mission Section */}
        <div className="mb-20">
          <h2 className="text-3xl font-display font-medium text-spruce mb-6 text-center">
            Our Mission
          </h2>

          <div className="bg-bone-light p-8 rounded-lg shadow-md">
            <p className="text-xl text-center text-secondary italic">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <FeatureCard
              icon={<Hammer className="h-8 w-8 text-spruce" />}
            ...
            <FeatureCard
              icon={<Users className="h-8 w-8 text-spruce" />}
            ...
            <FeatureCard
              icon={<ShoppingBag className="h-8 w-8 text-spruce" />}
        ...
        <div className="mb-20">
          ...
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-0 md:left-1/2 transform md:-translate-x-1/2 h-full w-1 bg-bone-dark"></div>
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/marketplace"
              className="px-6 py-3 bg-honey text-dark-teal rounded-md hover:bg-honey-light inline-flex items-center justify-center"
            >
            ...
            <Link
              to="/tools/new"
              className="px-6 py-3 bg-bone-light border border-spruce text-spruce rounded-md hover:bg-bone-dark inline-flex items-center justify-center"
            >
...
const FeatureCard = ({ icon, title, description }) => {
  return (
    <div className="bg-bone-light p-6 rounded-lg shadow-md">
      ...
      <h3 className="text-xl font-display font-medium text-spruce mb-2 text-center">
        {title}
      </h3>
...
const TimelineItem = ({ year, title, description, align }) => {
  return (
    <div className={`relative flex items-start ${align === 'right' ? 'md:flex-row-reverse' : 'md:flex-row'}`}>
      {/* Timeline dot */}
      <div className="absolute left-0 md:left-1/2 transform md:-translate-x-1/2 w-7 h-7 rounded-full bg-spruce border-4 border-bone-light z-10"></div>

      {/* Content */}
      <div className={`md:w-1/2 ${align === 'right' ? 'md:pr-20' : 'md:pl-20'} pl-20 md:pr-20`}>
        <div className="bg-bone-light p-6 rounded-lg shadow-md">
          <div className="flex items-center mb-2">
            <Calendar className="h-5 w-5 text-spruce mr-2" />
            <span className="text-spruce font-medium">{year}</span>
          </div>
          <h3 className="text-xl font-display font-medium text-spruce mb-2">
            {title}
          </h3>
