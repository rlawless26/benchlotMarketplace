  ...
  return (
    <div className="container">
      ...
      <div className="content">
        ...
        {!connectedAccountId && <p>Benchlot is the world's leading air travel platform: join our team of pilots to help people travel faster.</p>}
        {connectedAccountId && <h2>Add information to start accepting money</h2>}
        {connectedAccountId && <p>Benchlot partners with Stripe to help you receive payments while keeping your personal and bank details secure.</p>}
