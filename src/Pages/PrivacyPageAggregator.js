...
//
// Aggregator-chromed duplicate of PrivacyPage.js. The legacy PrivacyPage.js
// is preserved unchanged; this file is what the /privacy route renders now
// so the policy page sits under SiteHeader + SiteFooter like the rest of
// the post-pivot content pages.
//
// Content is copied verbatim from PrivacyPage.js — update in parallel if
// either file changes and you care about parity. Eventually the legacy file
// should be retired once nothing else references it.
